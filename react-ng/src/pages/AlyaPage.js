                  ...
                  <Alert severity="info">
                    ...
                    <Grid container spacing={2} sx={{ textAlign: "center" }}>
                      <Grid item>
                        ...
                        <Typography variant="h6">{YEARS_FMSG}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">МЕС</Typography>
                        <Typography variant="h6">{MONTHS_FMSG}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">ДНИ</Typography>
                        <Typography variant="h6">{DAYS_FMSG}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">ЧАС</Typography>
                        <Typography variant="h6">{HOURS_FMSG}</Typography>
                      </Grid>
                    </Grid>
                    <Grid container spacing={2} sx={{ textAlign: "center" }}>
                      <Grid item>
                ...
                <Box>
                  <Alert severity="info">
                    ...
                    <Grid container spacing={2} sx={{ textAlign: "center" }}>
                      <Grid item>
                        <Typography variant="caption">ГОД</Typography>
                        <Typography variant="h6">{YEARS_VFMSG}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">МЕС</Typography>
                        <Typography variant="h6">{MONTHS_VFMSG}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">ДНИ</Typography>
                        <Typography variant="h6">{DAYS_VFMSG}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">ЧАС</Typography>
                        <Typography variant="h6">{HOURS_VFMSG}</Typography>
                      </Grid>
                    </Grid>
                    <Grid container spacing={2} sx={{ textAlign: "center" }}>
                      <Grid item>
                ...
                <Box>
                  <Alert severity="info">
                    ...
                    <Grid container spacing={2} sx={{ textAlign: "center" }}>
                      <Grid item>
                        <Typography variant="caption">ГОД</Typography>
                        <Typography variant="h6">{YEARS_RKRR}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">МЕС</Typography>
                        <Typography variant="h6">{MONTHS_RKRR}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">ДНИ</Typography>
                        <Typography variant="h6">{DAYS_RKRR}</Typography>
                      </Grid>
                      <Grid item>
                        <Typography variant="caption">ЧАС</Typography>
                        <Typography variant="h6">{HOURS_RKRR}</Typography>
                      </Grid>
                    </Grid>
                    <Grid container spacing={2} sx={{ textAlign: "center" }}>
                      <Grid item>
                        <Typography variant="caption">
                          (С{" "}
                          {moment(REACH_KRR).format("Do MMMM YYYY, HH:mm:ss")})
                        </Typography>
                      </Grid>
                    </Grid>
                  </Alert>
