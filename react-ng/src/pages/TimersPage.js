...
/**
 * Кнопа жила у меня в квартире
 */
const KNOPA = [2025, 8, 4, 15, 0];
const KNOPA_LEAVES = moment([2025, 10, 4, 17, 0]);
const KNOPA_DATE = moment(KNOPA);
const YEARS_KNOPA = KNOPA_LEAVES.diff(KNOPA_DATE, "years");
KNOPA_DATE.add(YEARS_KNOPA, "years");
const MONTHS_KNOPA = KNOPA_LEAVES.diff(KNOPA_DATE, "months");
KNOPA_DATE.add(MONTHS_KNOPA, "months");
const DAYS_KNOPA = KNOPA_LEAVES.diff(KNOPA_DATE, "days");
KNOPA_DATE.add(DAYS_KNOPA, "days");
const HOURS_KNOPA = KNOPA_LEAVES.diff(KNOPA_DATE, "hours");
KNOPA_DATE.add(HOURS_KNOPA, "hours");

const TIMERS = [
  {
    id: 1,
    title: "Жил в Краснодаре",
    years: YEARS_MK,
    months: MONTHS_MK,
    days: DAYS_MK,
    hours: HOURS_MK,
  ...
  {
    id: 12,
    title: "Кнопа жила у меня в квартире",
    years: YEARS_KNOPA,
    months: MONTHS_KNOPA,
    days: DAYS_KNOPA,
    hours: HOURS_KNOPA,
