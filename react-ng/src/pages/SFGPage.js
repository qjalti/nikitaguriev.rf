...
import warcraftOther01 from "../files/sfg/warcraft_3_other/TheHornOfCenarius.wav";
import warcraftOther02 from "../files/sfg/warcraft_3_other/FrostmourneChant1.wav";
import warcraftOther03 from "../files/sfg/warcraft_3_other/KnightNoLumber1.wav";
import warcraftOther04 from "../files/sfg/warcraft_3_other/NecromancerNoGold1.wav";
import warcraftOther05 from "../files/sfg/warcraft_3_other/NecromancerNoFood1.wav";
...
import warcraftOther08 from "../files/sfg/warcraft_3_other/BloodlustTarget.wav";
import warcraftOther09 from "../files/sfg/warcraft_3_other/MirrorImage.wav";
import warcraftOther010 from "../files/sfg/warcraft_3_other/Levelupcaster.wav";
import warcraftOther011 from "../files/sfg/warcraft_3_other/AcolyteMining.wav";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Звуки из видеоигр — слушай онлайн" />
        <meta
                    ...
                    <Accordion key={soundsCounter}>
                      ...
                      <AccordionDetails>
                        ...
                        {sounds.sounds.map((sound) => (
                          <>
                            <Typography gutterBottom>{sound.text}</Typography>
                            <Box component="audio" src={sound.src} controls />
                          </>
                        ))}
                      </AccordionDetails>
                    </Accordion>
