  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="title" content="Резюме — Никита Гуриев" />
        <meta
          name="description"
        ...
        <meta property="og:title" content="Резюме — Никита Гуриев" />
        <meta
          property="og:description"
          content="Личное резюме Никиты Гуриева — Fullstack-разработчика с опытом в Bitrix24, Node.js, React, MongoDB и других технологиях."
        />
        <meta property="og:url" content="https://qjalti.ru/resume" />
        <meta property="og:image" content="https://qjalti.ru/programmer.webp" />
        <meta property="og:locale" content="ru_RU" />
        <meta property="og:site_name" content="qjalti.ru" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Резюме — Никита Гуриев" />
        <meta
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={4}>
                <Box>
                  ...
                  {IS_SEARCH_FOR_JOB ? (
                    <>
                      ...
                      <Alert severity="info" sx={{ mx: "auto", my: 2 }}>
                        {MINIMUM_SALARY ? (
                          <>
                            Зарплата от {MINIMUM_SALARY.toLocaleString("ru-RU")}{" "}
                            &#8381;
                          </>
                        ) : (
                          <>Зарплата договорная</>
                  ...
                  >
                    <Grid item>
                      <Button href={resumeFile}>Скачать резюме</Button>
                    </Grid>
                  </Grid>
                  <Grid
                    container
                  ...
                  >
                    <Grid item>
                      <Chip label="Fullstack разработчик" color="primary" />
                    </Grid>
                  </Grid>
                  <Grid
                    container
                  ...
                  <Alert severity="success" sx={{ my: 2 }}>
                    13.03.2022 <strong>победил</strong> в{" "}
                    <Button
                      href="https://iqarium.ru/hakatontime"
                      target="_blank"
                      size="small"
                    >
                      IT-Хакатоне
                    </Button>
                    , заняв <strong>третье</strong> место, среди{" "}
                    <strong>16</strong> команд. В команде исполнял роль{" "}
                    <strong>Backend разработчика</strong>. Использовал стек:{" "}
                    <em>nginx, Node.js, ExpressJS, MongoDB</em>. Кейс:{" "}
                    <strong>
                      Сервис для помощи в сортировке бытовых отходов
                    </strong>
                  </Alert>
                  ...
                  <Divider sx={{ mb: 2 }} />
                  <Box sx={{ my: 2 }}>
                    <Typography sx={{ fontWeight: "bold" }}>Имя</Typography>
                    <Typography>
                      {NAME} {SURNAME}
                    </Typography>
                  </Box>
                  <Box sx={{ my: 2 }}>
                    <Typography sx={{ fontWeight: "bold" }}>Возраст</Typography>
                    <Typography>{MY_AGE}</Typography>
                  </Box>
                  <Box sx={{ my: 2 }}>
                  ...
                  <Box sx={{ my: 2 }}>
                    <Typography sx={{ fontWeight: "bold" }}>Адрес</Typography>
                    <Typography>{ADDRESS_FL}</Typography>
                    <Typography>{ADDRESS_SL}</Typography>
                  </Box>
                  <Box sx={{ my: 2 }}>
                ...
                <Box>
                  ...
                  <Box sx={{ my: 2 }}>
                    {INTERESTS.map((el) => (
                      <Typography key={el.key}>{el.title}</Typography>
                    ))}
                  </Box>
                </Box>
                <Box>
                  ...
                  <Box sx={{ my: 2 }}>
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs>
                        <Typography sx={{ textAlign: "right" }}>A2</Typography>
                      </Grid>
                    </Grid>
                  </Box>
                </Box>
              ...
              <Grid item xs={12} md={8}>
                <Box>
                  ...
                  <Box sx={{ my: 2 }}>
                    <Typography gutterBottom>
                      ...
                      самозанятый и удалённо. Важно, чтобы в команде разработки
                      я был не один.
                    </Typography>
                    <Typography gutterBottom>
                      Опыт разработки приложений для Битрикс24 (как локальных,
                      так и для маркетплейса)
                    </Typography>
                    <Typography gutterBottom>
                    ...
                    <Typography gutterBottom>
                      Один из крупных проектов: проект для застройщика, в
                      который входят несколько приложений, а именно:
                    </Typography>
                    ...
                    страниц для печати
                    <br />
                    - Массовое изменение параметров квартир
                    <br />
                    - Финансовая статистика по квартирам (на сколько
                    продано/забронировано и др.)
                    <br />
                    - Подключение и настройка календаря (FullCalendar)
                    <br />
                    - Парсер информации по квартирам в XML-фид для таких
                    площадок как ДомКлик, Яндекс.Недвижимость, АЯКС, ЦИАН
                    <br />
                    <br />
                    ...
                    нужно будет какое-то время дополнительно изучить.
                    <br />
                    <br />
                    С чем не было опыта работы:
                    <br />
                  ...
                  <Box>
                    <Box sx={{ mt: 2 }}>
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography>
                            Разработка приложений для Битрикс24 (боты (
                            <Button
                              startIcon={<OpenInNewOutlinedIcon />}
                              href="https://www.bitrix24.ru/apps/?app=nicedo.uvedomlyashka"
                              target="_blank"
                            ...
                            ), отчёты (HTML, Word, Excel); XML-фиды (ДомКлик,
                            АЯКС, Яндекс.Недвижимость), действия с CRM,{" "}
                            <Button
                              startIcon={<OpenInNewOutlinedIcon />}
                              href="https://www.bitrix24.ru/apps/?app=nicedo.shakhmatka"
                              target="_blank"
                            ...
                            ), интеграция Битрикс24 с Битрикс управление сайтом,
                            ОКТЕЛЛ, опыт работы с CRON
                          </Typography>
                        </Grid>
                      </Grid>
                      <Grid container spacing={2}>
                        <Grid item>
                          <Chip sx={{ my: 1 }} size="small" label="PHP" />
                          <Chip
                            sx={{ my: 1 }}
                            size="small"
                            label="JavaScript"
                          />
                          <Chip sx={{ my: 1 }} size="small" label="Bootstrap" />
                        </Grid>
                      </Grid>
                    </Box>
                  </Box>
                  ...
                  <Box>
                    <Box sx={{ my: 2 }}>
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography sx={{ fontStyle: "italic" }}>
                            ООО &laquo;РН-Информ&raquo; &mdash; ООО ИК
                            &laquo;СИБИНТЕК&raquo;
                          </Typography>
                        </Grid>
                      </Grid>
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography>
                            ...
                            контроллерного оборудования, осуществление
                            программного сопровождения систем телемеханики и
                            техническое обслуживание объектов АСУ ТП
                          </Typography>
                        </Grid>
                      </Grid>
                      <Grid container spacing={2}>
                        <Grid item>
                          <Chip sx={{ my: 1 }} size="small" label="SCADA" />
                          <Chip sx={{ my: 1 }} size="small" label="Metso" />
                          <Chip sx={{ my: 1 }} size="small" label="DeltaV" />
                          <Chip
                            sx={{ my: 1 }}
                            size="small"
                            label="DirectLogic"
                          ...
                          />
                          <Chip sx={{ my: 1 }} size="small" label="FBD" />
                        </Grid>
                      </Grid>
                      <Grid container spacing={2}>
                        <Grid item>
                          <Chip
                            ...
                            label="JavaScript"
                          />
                          <Chip sx={{ my: 1 }} size="small" label="NodeJS" />
                        </Grid>
                      </Grid>
                    </Box>
                  </Box>
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          ...
                          <Chip
                            ...
                            label="JavaScript"
                          />
                          <Chip sx={{ my: 1 }} size="small" label="C#" />
                          <Chip sx={{ my: 1 }} size="small" label="MS SQL" />
                          <Chip sx={{ my: 1 }} size="small" label="Unity" />
                          <Chip sx={{ my: 1 }} size="small" label="CSS" />
                          <Chip sx={{ my: 1 }} size="small" label="HTML" />
                          <Chip
                            sx={{ my: 1 }}
                            size="small"
                            label="GPSS World"
                          />
                          <Chip sx={{ my: 1 }} size="small" label="AutoCAD" />
                          <Chip sx={{ my: 1 }} size="small" label="3DS Max" />
                        </Grid>
                      </Grid>
                    </Box>
                  </Box>
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography>
                            ...
                            Программирование в компьютерных системах на
                            факультете Информационных технологий и
                            вычислительной техники. Очная форма обучения
                          </Typography>
                        </Grid>
                      </Grid>
                      <Grid container spacing={2}>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    <Grid container>
                      <Grid item xs>
                        <Typography sx={{ fontWeight: "bold" }}>MUI</Typography>
                      </Grid>
                      <Grid item xs>
                        <LinearProgress
                          sx={{ mt: 1 }}
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    <Grid container spacing={2}>
                      <Grid item>
                        <Typography>
                          Полный гайд по созданию сайтов и приложений на
                          серверном JavaScript, включая базы данных и создание
                          API.
                        </Typography>
                        <Box>
                          <Chip
                          ...
                          />
                          <Chip sx={{ my: 1 }} size="small" label="ExpressJS" />
                          <Chip
                            sx={{ my: 1 }}
                            size="small"
