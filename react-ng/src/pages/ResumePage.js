                ...
                <Box>
                  ...
                  <Box sx={{my: 2}}>
                    <Typography gutterBottom>
                        ...
                        самозанятый и удалённо. Важно, чтобы в команде
                        разработки я
                        был не один.
                    </Typography>
                    <Typography gutterBottom>
                    ...
                    <Typography gutterBottom>
                      ...
                      - Шахматка.
                      Отображение/добавление/редактирование/изменение
                      квартир; бронирование (связка со сделкой); поиск квартир
                      по
                      фильтру; отображение дополнительной информации по ЖК
                      (связь
                      с универсальными списками); отображение статистики по
                      квартирам (сколько продано/в продаже/забронировано);
                      вёрстка
                      ...
                      нужно будет какое-то время дополнительно
                      изучить.<br/><br/>
                      ...
                      - React, Node.js<br/>
                      - ООП/MVC/SOLID<br/><br/>
                      Приложения для Битрикс24 - по большей части различные
                      отчёты
                  </Box>
                </Box>
                {/* Опыт работы */}
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography>
                              ...
                              startIcon={<OpenInNewOutlinedIcon/>}
                              href="https://www.bitrix24.ru/apps/?app=nicedo.uvedomlyashka"
                              target="_blank">Уведомляшка</Button>), отчёты
                              (HTML,
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography>
                              ...
                              контроллерного
                              оборудования, осуществление программного
                              сопровождения
                      ...
                      <Grid container spacing={2}>
                        <Grid item>
                          <Typography>
                              ...
                              управления на факультете Информационных технологий
                              и
